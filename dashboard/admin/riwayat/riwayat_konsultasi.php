		...
		<div class="table-responsive">
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
			  $sql = $koneksi->query("SELECT * FROM tb_hasil WHERE id_pengguna ='$data_id' ORDER BY id_hasil");
            ...
            ?>
					...
					<tr>
						...
						<td>
							...
							<a href="?page=del-riwayat&kode=<?php echo $data['id_hasil']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
